...
// Parent class for all Robot. Each subclass will have Provides update(), draw(), and handleCollision() methods.
public abstract class Robot {
    ...
    public Robot(float x, float y, Hitbox hitbox) {
        this.x = x;
        this.y = y;
        this.hitbox = hitbox;
    }
